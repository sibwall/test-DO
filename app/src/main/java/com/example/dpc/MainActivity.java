    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isWorkProfile) {
            ...
            tvDescription.setText("\n\nПривет!\n" +
                    ...
                    "После активации оно отключает USB-сигнал, блокирует биометрию и отключает агентов доверия, запрещает монтирование физических носителей, устанавливает лимит неверных попыток разблокировки экрана до сброса данных в 3 попытки, и отключает FRP. Для активации нужно только убедиться что у вас нет других рабочих профилей и выполнить ADB комманду.\n");
